...
# Notice : For Install pyglet library we must Use a VPN and run Below code in CMD
...
class RainyDayAnimation(pyglet.window.Window):
    def __init__(self, width = None, height = None):
        ...
        self.horn_sound =pyglet.media.load('data\Sound\HORN.wav',
                                           streaming=False)
    ...
    def createDrawableObjects(self):
        ...
        num_rows = 4
        num_columns = 1
        droplet = 'data/Images/droplet.png'
        ...
        cloud = pyglet.image.load('data/Images/cloud.png')
        self.cloudSprite = pyglet.sprite.Sprite(cloud)
        self.cloudSprite.y = 100

        lightening = pyglet.image.load('data/Images/lightening.png')
        self.lSprite = pyglet.sprite.Sprite(lightening)
        self.lSprite.y = 200

        car = pyglet.image.load('data/Images/car.png')
